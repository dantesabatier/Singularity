...
final class Provider
{
    ...
    public static function anthropic(): self
    {
        return new self(
            ...
            apiKey: "",
            models: new ArrayClass([new Model("Opus 4.7", "claude-opus-4-7", "opus"), new Model("Sonnet 4.6", "claude-sonnet-4-6", "sonnet"), new Model("Haiku 4.5", "claude-haiku-4-5-20251001", "haiku")])
        );
    }
}
